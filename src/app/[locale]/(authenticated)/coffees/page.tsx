              ...
              filteredCoffees.map((coffee) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex w-full flex-col gap-1 rounded-2xl border p-4 text-left transition ${
                      isActive
          ...
          {!selectedCoffee ? (
            ...
            <div className="flex h-full flex-col gap-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <article className="rounded-2xl border border-surface-700/60 bg-surface-900/80 p-4">
                    ...
                    brews.map((brew) => (
                      ...
                      >
                        <header className="flex items-center justify-between">
                          <div>
                            <p className="text-sm font-medium capitalize text-white">{brew.method}</p>
          ...
          >
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button
                ...
                className="hover:border-surface-500 rounded-full border border-surface-700 px-4 py-2 text-sm text-muted-300 hover:text-white"
              >
                Cancelar
              </button>
              <button
